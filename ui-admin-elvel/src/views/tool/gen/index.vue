<template>
  <div class="app-container">
    ...
    <el-table ref="tables" v-loading="loading" :data="tableList" @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
      ...
      <el-table-column label="表名称" align="center" prop="tableName" :show-overflow-tooltip="true" width="240" />
      <el-table-column label="表描述" align="center" prop="tableComment" :show-overflow-tooltip="true" width="240" />
  ...
  methods: {
    ...
    handleGenTable(row) {
      ...
      if(row.genType === "1") {
        ...
        const zipName = Array.isArray(tableNames) ? "elvel.zip" : tableNames + ".zip"
