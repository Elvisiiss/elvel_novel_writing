package com.elvel.common.utils.file;
...
import com.elvel.common.exception.file.FileNameLengthLimitExceededException;
import com.elvel.common.exception.file.FileSizeLimitExceededException;
import com.elvel.common.exception.file.InvalidExtensionException;
import com.elvel.common.utils.DateUtils;
import com.elvel.common.utils.StringUtils;
import com.elvel.common.utils.uuid.IdUtils;
import com.elvel.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = ElvelConfig.getProfile();
    ...
    {
        int dirLastIndex = ElvelConfig.getProfile().length() + 1;
